...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final TomLibraryAccessors laccForTomLibraryAccessors = new TomLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>tom</b>
     */
    public TomLibraryAccessors getTom() {
        return laccForTomLibraryAccessors;
    }
    ...
    public static class FirebaseAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2230</b> with <b>com.google.firebase:firebase-auth</b> coordinates and
         * with version reference <b>firebaseAuthVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2230() {
            return create("firebase.auth.v2230");
        }
    ...
    public static class PdfboxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>org.apache.pdfbox:pdfbox-android</b> coordinates and
    ...
    public static class TomLibraryAccessors extends SubDependencyFactory {
        private final TomRoushLibraryAccessors laccForTomRoushLibraryAccessors = new TomRoushLibraryAccessors(owner);

        public TomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>tom.roush</b>
         */
        public TomRoushLibraryAccessors getRoush() {
            return laccForTomRoushLibraryAccessors;
        }

    }

    public static class TomRoushLibraryAccessors extends SubDependencyFactory {
        private final TomRoushPdfboxLibraryAccessors laccForTomRoushPdfboxLibraryAccessors = new TomRoushPdfboxLibraryAccessors(owner);

        public TomRoushLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>tom.roush.pdfbox</b>
         */
        public TomRoushPdfboxLibraryAccessors getPdfbox() {
            return laccForTomRoushPdfboxLibraryAccessors;
        }

    }

    public static class TomRoushPdfboxLibraryAccessors extends SubDependencyFactory {

        public TomRoushPdfboxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.tom-roush:pdfbox-android</b> coordinates and
         * with version reference <b>pdfboxAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("tom.roush.pdfbox.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseAuthVersion</b> with value <b>22.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pdfboxAndroid</b> with value <b>1.8.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pdfboxAndroidVersion</b> with value <b>2.0.27.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPdfboxAndroidVersion() { return getVersion("pdfboxAndroidVersion"); }
